...
public class FilterPlatform implements Serializable {
   private static final long serialVersionUID = 1815513091523563687L;
   private String key;
   private String name;
   ...
   public FilterPlatform(String name, String key, String dataType, String type, Object value) {
      this.key = key;
      this.name = name;
      this.value = value;
   ...
   public FilterPlatform(String name, String key, String dataType, String type, Object value, String exclude) {
      this.key = key;
      this.name = name;
      this.value = value;
      this.dataType = dataType;
   ...
   public boolean equals(Object o) {
      FilterPlatform filter = (FilterPlatform)o;
      if (!(this.value instanceof List)) {
         if (this.value == null || filter.getValue() == null) {
            return true;
         } else {
   ...
   private boolean timeCompare(FilterPlatform filter1, FilterPlatform filter2) {
