...
public class ExactAnalyzer extends Analyzer implements Serializable {
   protected TokenStreamComponents createComponents(String s, Reader reader) {
      return new TokenStreamComponents(new ExactAnalyzer.ExactTokenizer(reader));
   }
   ...
   public static List<String> analyze(String str) {
      ...
      try {
         ExactAnalyzer.ExactTokenizer tokenizer = new ExactAnalyzer.ExactTokenizer(new StringReader(str));
