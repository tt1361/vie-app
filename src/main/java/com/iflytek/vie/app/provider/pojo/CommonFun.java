...
public class CommonFun {
   ...
   public static TagInfo voicePositionToTime(TagInfo tagInfo, List<String> timeList, List<Integer> positionList, int contentLength) {
      TagInfo result = null;
   ...
   public static TagInfo voicePositionToTimeByText(TagInfo tagInfo, int contentLength, int nextLength) {
      TagInfo result = null;
