...
public class DataInfoPlatform implements Serializable {
   private static final long serialVersionUID = 8102416574840271168L;
   private String id;
   private int mark;
   private int isExist;
   ...
   public DataInfoPlatform() {
   }

   public DataInfoPlatform(String id, int mark, int isExist) {
      this.id = id;
      this.mark = mark;
